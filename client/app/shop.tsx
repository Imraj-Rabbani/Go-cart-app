...
export default function Shop() {
    ...
    const [filter, setFilter] = useState<{ category?: string; gender?: string; priceRange?: string }>({
        category: '',
        gender: '',
        priceRange: '',
    });
    const [sortBy, setSortBy] = useState<'newest' | 'oldest' | 'price' | 'ratings'>('newest');
    ...
    return (
        <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
            <Header title="Shop" showBack={true} showSearch={false} showCart={true} showMenu={false} showLogo={false} />  
            ...
            <View className='flex-row gap-2 mb-3 mx-4 my-2'>
                ...
                <View className='flex-1 flex-row items-center bg-white rounded-xl border border-gray-100'>
                    ...
                    <TextInput className='flex-1 ml-2 text-primary px-3 py-4' placeholder='Search' returnKeyType='search' />
                </View>
                {/* Filter Icon */}
