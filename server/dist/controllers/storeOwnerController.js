...
export const getStoreOwnerProducts = async (req, res) => {
    try {
...
export const createStoreOwnerProduct = async (req, res) => {
    try {
        const store = await getStoreByUser(req.user._id);
...
export const updateStoreOwnerProduct = async (req, res) => {
    try {
        const store = await getStoreByUser(req.user._id);
...
export const deleteStoreOwnerProduct = async (req, res) => {
    try {
        const store = await getStoreByUser(req.user._id);
        const product = await Product.findById(req.params.productId);
        if (!product) {
...
export const getStoreOwnerOrders = async (req, res) => {
    try {
        const store = await getStoreByUser(req.user._id);
...
export const getStoreOwnerRevenue = async (req, res) => {
    try {
        const store = await getStoreByUser(req.user._id);
